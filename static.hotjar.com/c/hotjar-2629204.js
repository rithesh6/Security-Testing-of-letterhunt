window.hjSiteSettings = window.hjSiteSettings || {
    ...
    "features": ["settings.billing_v2", "ingestion.http.page_content", "client_script.safe_date", "heatmap.continuous.manual_retaker", "feedback.embeddable_widget", "error_reporting", "survey.image_question", "feedback.widgetV2", "client_script.metrics"]
};
...
! function(e) {
    ...
    221: function(e, t, r) {
            ...
            j = {
                ...
                start: function() {
                    try {
                        ...
                        d.genericTags = {
                            site_id: r
                        }, d.isDebugEnabled = n.has(o.flag) && Math.random() <= o.sampling, d.isMetricsEnabled = n.has(s.flag) && Math.random() <= s.sampling, l = new a(w, h.buffer.bufferSize, h.buffer.flushInterval)
                    } catch (e) {
                ...
                count: function(e, t) {
                    ...
                    try {
                        var o = b(n),
                            a = d.loggedMetrics[e],
                            s = 0;
                        if (r) s = (a && a[o] || 0) + (r.value || 1), d.loggedMetrics[e] = u(u({}, a), {}, c({}, o, (null == r ? void 0 : r.flush) ? 0 : s));
                        else s = 1;
                        if (m(r)) {
                            var f = {
                                name: e,
        ...
        window.hj = window.hj || function() {
            ...
            h.async = 1, h.src = hj.scriptDomain + t, h.charset = "utf-8", f.appendChild(h), c.revision = "8f9c64e2e03c", window.hjBootstrap = c
        }, window.hjBootstrap("https://script.hotjar.com/", "modules.7c9d2150b61706b30307.js", "2629204"), window.hjLazyModules = window.hjLazyModules || {
            SURVEY_V2: {
